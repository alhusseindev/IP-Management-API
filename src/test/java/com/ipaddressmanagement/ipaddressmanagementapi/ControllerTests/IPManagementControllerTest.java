...
public class IPManagementControllerTest {
    ...
    @MockBean
    private IPManagementRepository myIPRep;
    ...
    void newIPEndpointTest() throws Exception{
        RequestBuilder myRequest = MockMvcRequestBuilders.post("/api/new").content("10.0.0.1/24");
    ...
    void listIPsEndpointTest() throws Exception{
        RequestBuilder myRequest = MockMvcRequestBuilders.get("/api/list");
        MvcResult myRequestResults = mvcMock.perform(myRequest).andReturn();
    ...
    void acquireIPEndpointTest() throws Exception{
        RequestBuilder myRequest = MockMvcRequestBuilders.patch("/api/acquire/{ipAddress}", "10.0.0.1");
        MvcResult myRequestResults = mvcMock.perform(myRequest).andReturn();
